 ...
 * and the mic are live. The other three are dimmed and inert until their
...
export function TabBar() {
  ...
  const current = path === "/people" || path.startsWith("/people/") ? "people" : null;
